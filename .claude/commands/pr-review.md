...
Review all staged/unstaged changes, or specify files to review.
...
- Registration order respects dependency graph
...
After review, run `flutter analyze` and `flutter test` and report results.
...
### Errors
- [file.dart:L42] Description

### Warnings
- [state.dart] Description

### Info
- [cubit.dart] Description
